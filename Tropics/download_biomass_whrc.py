...
# Projections
proj_Afr_proj4 = ("+proj=aea +lat_1=20 +lat_2=-23 +lat_0=0 +lon_0=25 "
                  "+x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs")
proj_Asi_proj4 = ("+proj=aea +lat_1=7 +lat_2=-32 +lat_0=-15 +lon_0=125 "
                  "+x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs")
proj_Ame_proj4 = ("+proj=aea +lat_1=-5 +lat_2=-42 +lat_0=-32 +lon_0=-60 "
                  "+x_0=0 +y_0=0 +ellps=aust_SA +units=m no_defs")
proj_Afr_wkt = ('PROJCS["Africa_Albers_Equal_Area_Conic",'
                'GEOGCS["GCS_WGS_1984",'
                'DATUM["WGS_1984",'
...
proj_Asi_wkt = ('PROJCS["Asia_South_Albers_Equal_Area_Conic",'
                'GEOGCS["GCS_WGS_1984",'
                'DATUM["WGS_1984",'
                'SPHEROID["WGS_1984",6378137,298.257223563]],'
                'PRIMEM["Greenwich",0],'
...
proj_Ame_wkt = ('PROJCS["South_America_Albers_Equal_Area_Conic",'
...
def run_country(iso3):
    ...
    if cont == "Africa":
        proj_proj4 = proj_Afr_proj4
        proj_wkt = proj_Afr_wkt
    elif cont == "Asia":
        proj_proj4 = proj_Asi_proj4
        proj_wkt = proj_Asi_wkt
    else:
