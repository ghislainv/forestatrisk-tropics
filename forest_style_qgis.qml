...
<qgis minScale="1e+08" maxScale="0" version="3.10.2-A Coruña" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    <rasterrenderer type="singlebandpseudocolor" opacity="1" alphaBand="-1" classificationMax="1" band="1" classificationMin="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" classificationMode="1" clip="0">
          ...
          <item color="#228b22" label="1" value="1" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
