...
#iso3 = "MDG"
if iso3 == "REU":
    extent_latlong = [55.216251, -21.389860, 55.837360, -20.871805]  # REU
elif iso3 == "MDG":
    extent_latlong = [43.10, -25.15, 51.70, -11.80]  # MDG
else:
...
Transition=ee.ImageCollection(
    "users/ClassifLandsat072015/Roadless2019/TransitionMap_1982_2019").mosaic().unmask()
OtherLC = (Transition.gte(90)).Or(Transition.eq(71)).Or(Transition.eq(72))
AnnualChangeYear = ee.ImageCollection(
    "users/ClassifLandsat072015/Roadless2019/AnnualChanges_1982_2019").mosaic().toByte()
AnnualChange = AnnualChangeYear.where(
    OtherLC.And((AnnualChangeYear.eq(13)).
        Or(AnnualChangeYear.eq(14)).
            Or(AnnualChangeYear.eq(16))),15)
AP = AnnualChange.clip(region)
...
#Map.addLayer(AP.updateMask(AP), {}, "forest2000-2020", True)

# ap_allYear: forest if Y = 1, 2, 3, 4, 5, 13, 14.
...
# Map
Map.addLayer(forest.updateMask(forest), {"palette": Palette}, "forest2000-2020", True)
if iso3 == "REU":
