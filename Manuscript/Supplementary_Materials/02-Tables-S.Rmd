...
(ref:cap-par) **Parameter estimates for each study area**. We computed the posterior mean of each parameter for each study-area. Continuous variables were normalized (mean=0 and standard-deviation=1) allowing us to compare variable importance at decreasing deforestation within and between study-areas.\vspace{0.5cm} 
