...
## Table S1 -- Categories of the forest cover annual product {-}
...
(ref:cap-variables) **Set of explanatory variables used to model the spatial probability of deforestation**. A total of height variables were tested. They indicate topography, forest accessibility, forest landscape, deforestation history, and conservation status.\vspace{0.5cm}
