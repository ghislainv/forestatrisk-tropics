...
#+LATEX_HEADER: \authorcontributions{Author contributions: GV and FA conceived the study; CV provided the forest cover change data; CB and PP helped to compute the carbon emissions; PV helped to write scripts for the high performance computing cluster; GV performed analysis and wrote the original draft; all authors reviewed and edited the final manuscript.}
