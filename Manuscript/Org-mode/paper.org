...
This would also lead to a faster decrease in carbon absorption by tropical forests down to 0.267 Pg/yr in 2100, and a faster increase in carbon emissions up to 0.749--0.793 Pg/yr (Fig. [[fig:c-em]] and [[SI:][/SI Appendix/, Fig. S13]]), turning tropical moist forests into an even bigger net carbon source.
