...
\fancyhead[L]{\includegraphics[width=3cm]{figs_article/Nature_logo.png}}
\fancyhead[C]{Submitted Manuscript: Confidential}
\fancyhead[R]{}
...
{\centering \includegraphics[width=\textwidth]{figs_article/fcc2100} 
...
{\centering \includegraphics[width=\textwidth]{figs_article/perc_loss_cont} 
...
{\centering \includegraphics[width=\textwidth]{figs_article/prob_zoom} 
...
{\centering \includegraphics[width=\textwidth]{figs_article/C_trend} 
...
{\centering \includegraphics[width=\textwidth]{figs_article/proba-var} 
...
\newblock \bibinfo{title}{Impacts on regional climate of amazon deforestation}.
...
\newblock \bibinfo{title}{Modelling conservation in the amazon basin}.
...
\newblock \bibinfo{title}{Bioclimatic envelope models predict a decrease in
  tropical forest carbon stocks with climate change in {Madagascar}}.
...
\newblock \bibinfo{title}{Age, extent and carbon storage of the central congo
  basin peatland complex}.
...
\newblock \bibinfo{title}{Cracking brazil{\textquotesingle}s forest code}.
\newblock \emph{\bibinfo{journal}{Science}} \textbf{\bibinfo{volume}{344}},
...
\newblock \bibinfo{title}{O avanço do desmatamento sobre as Áreas protegidas
  em rondônia}.
...
\newblock \bibinfo{title}{Dynamique foresti{\`{e}}re post-conflits arm{\'{e}}s
  de la for{\^{e}}t class{\'{e}}e du haut-sassandra (c{\^{o}}te d'ivoire)}.
...
\newblock \bibinfo{title}{It's not just poverty: unregulated global market and
  bad governance explain unceasing deforestation in western madagascar}.
...
\newblock \bibinfo{title}{Attribution of {C02} emissions from brazilian
...
\bibitem{Jones2019}
\bibinfo{author}{Jones, J. P.~G.} \emph{et~al.}
\newblock \bibinfo{title}{Last chance for madagascar’s biodiversity}.
\newblock \emph{\bibinfo{journal}{Nature Sustainability}}
  \textbf{\bibinfo{volume}{2}}, \bibinfo{pages}{350--352}
  (\bibinfo{year}{2019}).
%\newblock \urlprefix\url{https://doi.org/10.1038/s41893-019-0288-0}.

\bibitem{Pendrill2019}
\bibinfo{author}{Pendrill, F.} \emph{et~al.}
\newblock \bibinfo{title}{Agricultural and forestry trade drives large share of
  tropical deforestation emissions}.
\newblock \emph{\bibinfo{journal}{Global Environmental Change}}
  \textbf{\bibinfo{volume}{56}}, \bibinfo{pages}{1--10} (\bibinfo{year}{2019}).
%\newblock \urlprefix\url{https://doi.org/10.1016/j.gloenvcha.2019.03.002}.
...
\newblock \bibinfo{title}{Death to kappa: birth of quantity disagreement and
...
\newblock \bibinfo{title}{Why environmental scientists are becoming bayesians}.
...
\newblock \bibinfo{title}{forestatrisk: a {P}ython package for modelling and
  forecasting deforestation in the tropics}.
...
\newblock \bibinfo{title}{Modelling land cover change in the brazilian amazon:
  temporal changes in drivers and calibration issues}.
...
\newblock \bibinfo{title}{Dinamica - a stochastic cellular automata model
  designed to simulate the landscape dynamics in an amazonian colonization
  frontier}.
...
\newblock \bibinfo{title}{How well does random forest analysis model
  deforestation and forest fragmentation in the brazilian atlantic forest?}
...
\begin{center}
  ~\\%%\includegraphics[width=3cm]{figs_sm/NCC_logo.png}\\
  \vspace{0.5cm}
...
\begin{center}\includegraphics[width=\textwidth]{figs_sm/study_areas_America} \end{center}

\begin{center}\includegraphics[width=\textwidth]{figs_sm/study_areas_Africa} \end{center}

\begin{figure}[H]

{\centering \includegraphics[width=\textwidth]{figs_sm/study_areas_Asia} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/fcc123} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/var} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/roads} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/pa} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/corr-var} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/sample} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/grid} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/rho} 
...
{\centering \includegraphics[width=0.98\textwidth]{figs_sm/prob} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/fcc2050_2100} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/AGB} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/fcc2100_min} 
...
{\centering \includegraphics[width=\textwidth]{figs_sm/fcc2100_max} 
